...
const dataHeaderDepartments: IDepartmentsLink[] = [
    {
        ...
        submenu: {
            type: 'megamenu',
            size: 'xl',
            image: 'https://red-parts.react.themeforest.scompiler.ru/themes/red/images/departments/departments-2.jpg',
            columns: [
                {
                    size: '1of5',
                    links: [
    ...
    },
    {
        ...
        submenu: {
            type: 'megamenu',
            size: 'lg',
            image: 'https://red-parts.react.themeforest.scompiler.ru/themes/red/images/departments/departments-1.jpg',
            columns: [
                {
                    size: 3,
                    links: [
    ...
    },
    {
        ...
        submenu: {
            type: 'megamenu',
            size: 'md',
            image: 'https://red-parts.react.themeforest.scompiler.ru/themes/red/images/departments/departments-3.jpg',
            columns: [
                {
                    size: 4,
                    links: [
    ...
    },
    {
        ...
        submenu: {
            type: 'megamenu',
            size: 'nl',
            image: 'https://red-parts.react.themeforest.scompiler.ru/themes/red/images/departments/departments-4.jpg',
            columns: [
                {
                    size: 6,
                    links: [
